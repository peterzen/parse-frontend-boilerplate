module.exports = function (grunt) {
    ...
    var getIndexPath = function () {
        ...
        if (grunt.config('target') !== 'development') {
            indexPath = 'backend/ParseCloud/public/index.html';
        }
        return indexPath;
    };
    ...
    grunt.registerTask('development', ['less:development', 'buildTemplates']);
    grunt.registerTask('production', ['bower-install-simple:production', 'less:production', 'copy', 'buildRequirejsConfig', 'requirejs', 'buildTemplates']);
