module.exports = function (grunt) {
    ...
    /**
     * Heroku deployment/build tasks
     */
    grunt.registerTask('heroku:production', ['bower-install-simple', 'production']);
    grunt.registerTask('heroku:development', ['bower-install-simple', 'development']);
